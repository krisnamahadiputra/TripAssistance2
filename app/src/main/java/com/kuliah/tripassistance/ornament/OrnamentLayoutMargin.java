package com.kuliah.tripassistance.ornament;
...
public class OrnamentLayoutMargin extends BaseLayout {
    public OrnamentLayoutMargin(@Px int spacing) {
        super(1, spacing);
    }

    public OrnamentLayoutMargin(int spanCount, @Px int spacing) {
